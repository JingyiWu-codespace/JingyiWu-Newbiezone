...
//        for (int i = 0; i < 10; i++) {
//            addNote(track, channel, myNoteIMPL.getLa(-2), 100, i * (beat/2),4,i*(beat/2)+1);
//        }
    ...
    public static void right(Track track, int channel, MyNoteIMPL myNoteIMPL, int volume, int tick, int beat, int length) throws Exception {
        ...
        tick += addNote(track, channel, myNoteIMPL.getRe(1), volume, tick, beat / 2, tick + beat / 4 / 4);
        tick += addNote(track, channel, myNoteIMPL.getDo(1), volume, tick, beat / 4, tick + beat / 4 / 4);
        tick += addNote(track, channel, myNoteIMPL.getDo(1), volume, tick, beat / 4, tick + beat / 4 / 4);
        ...
        tick += addNote(track, channel, myNoteIMPL.getDo(1), volume, tick, beat / 4, tick + beat / 4 / 4);
        tick += addNote(track, channel, myNoteIMPL.getRe(1), volume, tick, beat / 4, tick + beat / 4 / 4);
        tick += addNote(track, channel, myNoteIMPL.getRe(1), 0, tick, beat / 2, tick + beat);
        tick += addNote(track, channel, myNoteIMPL.getMi(1), volume, tick, beat / 2, tick + beat / 4 / 4);
        tick += addNote(track, channel, myNoteIMPL.getMi(1), volume, tick, beat, tick + beat / 4 / 4);
        ...
        tick += addNote(track, channel, myNoteIMPL.getRe(1), volume, tick, beat / 4, tick + beat / 4 / 4);
        tick += addNote(track, channel, myNoteIMPL.getRe(1), 0, tick, beat / 2, tick + beat);
        tick += addNote(track, channel, myNoteIMPL.getSol(1), volume, tick, beat / 2, tick + beat / 4 / 4);
        tick += addNote(track, channel, myNoteIMPL.getMi(1), volume, tick, beat, tick + beat / 4 / 4);
